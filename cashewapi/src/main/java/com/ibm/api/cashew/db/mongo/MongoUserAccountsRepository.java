...
{
	public UserAccount findByAppUsernameAndAccountIdAndAccountBankIdAndAccountUsername(String username,
			String accountId, String bankId, String bankUsername);

	public UserAccount findByAccountIdAndAccountBankIdAndAccountUsername(String accountId, String bankId,
			String bankUsername);
